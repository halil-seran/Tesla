...
export default function TeslaY({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.background}>
        ...
        >
          <Video
            ...
            shouldPlay
            source={{
              uri: "https://digitalassets.tesla.com/tesla-contents/video/upload/f_auto,q_auto/Model-Y-Main-Hero-Mobile-Video-NA.mp4",
            }}
            style={{ flex: 1 }}
          />
        </Animated.View>
      ...
      <View style={styles.overlay}>
        ...
        <View>
          <Text style={styles.headerStyle}>Model Y</Text>
        </View>
        <View>
          <Text style={styles.priceStyle}>Lease starting at $399/mo*</Text>
        </View>
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate("Orders", { carName: "TeslaY" })}
        >
          <Text
            style={[
              styles.carFeature,
