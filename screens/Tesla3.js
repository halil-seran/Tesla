...
export default function Tesla3({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.background}>
        ...
        >
          <Video
            ...
            shouldPlay
            source={{
              uri: "https://digitalassets.tesla.com/tesla-contents/video/upload/f_auto,q_auto/Model-3-Main-Hero-Mobile-LHD-Animation.webm",
            }}
            style={{ flex: 1 }}
          />
        </Animated.View>
      ...
      <View style={styles.overlay}>
        ...
        <View>
          <Text style={styles.headerStyle}>Model 3</Text>
        </View>
        <View>
          <Text style={styles.priceStyle}>Lease starting at $329/mo*</Text>
        </View>
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate("Orders", { carName: "Tesla3" })}
        >
          <Text
            style={[
              styles.carFeature,
