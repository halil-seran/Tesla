...
export default function TeslaS({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.background}>
        ...
        >
          <Video
            ...
            shouldPlay
            source={{
              uri: "https://digitalassets.tesla.com/tesla-contents/video/upload/f_auto,q_auto/Model-S-Main-Hero-Mobile-LHD-Animation-v2.webm",
            }}
            style={{ flex: 1 }}
          />
        </Animated.View>
      ...
      <View style={styles.overlay}>
        ...
        <View>
          <Text style={styles.headerStyle}>Model S</Text>
        </View>
        <View>
          <Text style={styles.priceStyle}>From $71,090*</Text>
        </View>
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate("Orders", { carName: "TeslaS" })}
        >
          <Text
            style={[
              styles.carFeature,
