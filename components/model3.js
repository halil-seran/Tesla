...
export const model3 = () => {
  const [totalPrice, setTotalPrice] = useState(28490);
  const [price, setPrice] = useState(28490);
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={styles.textStyles}>
              ...
              <Text style={{ fontWeight: 600 }}>${totalPrice - 10500}</Text>
            </View>
            <View
              style={{ height: 2, backgroundColor: "black", marginTop: 7 }}
            ></View>
      ...
      <>
        ...
        <View style={styles.modelPicker}>
          <RNPickerSelect
            ...
            placeholder={{
              label: "Model 3   $28,490",
              value: 28490,
            }}
            items={[
              { label: "Model 3 Long Range   $35,490", value: 35490 },
              { label: "Model 3 Performance   $40,490", value: 40490 },
            ]}
          />
          <Text style={styles.motorTypeInfo}>
            * Prices assume $7,500 IRA Federal Tax Credit (not all customers
            qualify) and est. gas savings of $3,000 over 3 years
          </Text>
        </View>
        ...
        <View style={styles.modelPicker}>
          <RNPickerSelect
            ...
            placeholder={{
              label: "18’’ Aero Wheels",
              value: "18’’ Aero Wheels",
            }}
            items={[
              {
                label: "19’’ Sport Wheels",
          ...
          {wheels === "18’’ Aero Wheels" ? (
            ...
            <>
              <Text style={styles.colorDetailStyle}>$1,500</Text>
              <Text style={styles.colorDetailStyle}>Range (est.) : 267mi</Text>
            </>
          )}
